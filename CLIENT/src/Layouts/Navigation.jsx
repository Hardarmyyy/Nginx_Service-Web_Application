...
<>
    <header className='w-full super:px-60 bg-black sticky top-0 z-50'>
        ...
        <div className='w-full px-4 py-2 flex justify-between items-center'>
            ...
            {!show && 
                <button type="button" onClick={() => setShow(!show)} className="tablet:hidden mini:hidden laptop:hidden super:hidden inline-flex items-center p-2 w-10 h-10 justify-center sm:text-sm md:text-lg text-white rounded-lg focus:outline-none">
            ...
            {show && 
                <aside className="fixed bg-my-bg w-full top-0 left-0 z-50 h-screen transition-transform tablet:hidden mini:hidden laptop:hidden super:hidden">

                    <div className="sm:w-3/4 md:w-1/2 h-screen overflow-y-auto bg-[#2b2b2b]">

                        <div className='flex justify-between items-center border-b-2 px-4 py-1'>

                            <Logo></Logo>
                            <button type="button" onClick={() => setShow(!show)} className="tablet:hidden mini:hidden laptop:hidden super:hidden inline-flex items-center p-2 w-10 h-10 justify-center sm:text-sm md:text-lg text-white rounded-lg focus:outline-none transition duration-75">
                        ...
                        <ul className="space-y-2 p-3 font-medium">
                            ...
                            <li>
                                <button type="button" onClick={() => setShow(!show)} className="transition duration-75">
                            ...
                            <li>
                                <button type="button" onClick={() => setShowDropDown(!showDropDown)} className="flex items-center w-full pl-2 pr-4 text-base text-white transition duration-75">
                                ...
                                {showDropDown && 
                                    <ul className="py-2 space-y-2">
                                        ...
                                        <li>
                                            <button type="button" onClick={() => hideSubPanel()} className="transition duration-75">
